...
const render = () => {
    ...
    // Challenge
    // For each character in string, add a span into #puzzle
        
        
        
        // So split the string to make it an array,
    game1.puzzle.split('').forEach((letter) => {
        // for each letter, create span element
...
startGame()
// startGame references the startGame funciton
